...
### Token Usage Tracking (Informational)

PR comments now include a "Resource Usage" section showing token consumption:
...
| Tokens/point | Efficiency metric (lower = better) |

**Why we track but don't score (yet):**
...
Token data is displayed in a collapsed `<details>` section to keep PR comments clean.
